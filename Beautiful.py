...
import sqlite3
from bs4 import BeautifulSoup as soup
from WebhookDiscord import Webhook
...
def send_embed(product):
    ...
    url = 'https://discord.com/api/webhooks/824106362593214484/-2F7aWO9P3qG8fJ09IUVSQM8GO2d8wL0p0W_vkcpaNIfW8zHHs7IngNdNmO2Dp4eGEjo'
    ...
    embed.set_footer(text='Breezy', icon='https://static.zerochan.net/Daenerys.Targaryen.full.2190849.jpg', ts=True)
